...
// void MyCrystal(int rs, int rw, int enable,
...
void MyCrystal(int rs, int enable,
			     int d0, int d1, int d2, int d3,
			     int d4, int d5, int d6, int d7)
{
  init1(0, rs, 255, enable, 0, 0, 0, 0, d4, d5, d6, d7);
}
...
void init1(int fourbitmode, int rs, int rw, int enable,
			 int d0, int d1, int d2, int d3,
			 int d4, int d5, int d6, int d7)
{
  _rs_pin = rs;
